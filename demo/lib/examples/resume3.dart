...
Future<Uint8List> generateResume3(PdfPageFormat format, CustomData data) async {
            ...
            pw.Partition(
                ...
                children: [
                  pw.Container(
                    ...
                    pw.Column(children: <pw.Widget>[
                      _Percent(size: 60, value: .8, title: pw.Text('Word')),
                      pw.SizedBox(height: 10),
                      _Percent(
                          size: 60, value: .6, title: pw.Text('Excel')),
                    ]),
                    //----------------------------------------------------------------------
              ...
              //----------------------------------------------------------------------
                ...
                pw.Column(children: <pw.Widget>[
                      ...
                      _Percent(size: 30, value: .9, title: pw.Text('Español')),
                      pw.SizedBox(height: 10),
                      _Percent(
            ...
            pw.Partition(
              child: pw.Column(
                ...
                children: <pw.Widget>[
                  ...
                  pw.SizedBox(height: 30),
                  _Category(title: 'Work Experience2'),
                  _Block(
                      title: 'Tour bus driver',
                      icon: const pw.IconData(0xe530)),
                  _Block(
